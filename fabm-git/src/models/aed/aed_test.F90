...
MODULE aed_test
!-------------------------------------------------------------------------------
! aed_test --- test biogeochemical model
!
! The AED module test contains equations that describe exchange of
! soluable reactive test across the air/water interface and sediment flux.
!-------------------------------------------------------------------------------
   USE aed_core
