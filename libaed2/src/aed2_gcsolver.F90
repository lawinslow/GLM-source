...
!  DOUBLETYPE,   DIMENSION(:)  :: partConcs, dissConcs             !
   ...
   WRITE(*,"(4X,'Initialise geochemical properties...')")
...
!                                                                              !
!------------------------------------------------------------------------------!
 SUBROUTINE UpdateEquilibration(dissConcs, partConcs, concMode, inTemp, stoEq, IAP, upDerv)
!  DOUBLETYPE,   DIMENSION(:)  :: partConcs, dissConcs             !
   AED_REAL,   DIMENSION(:)  :: partConcs, dissConcs             !
